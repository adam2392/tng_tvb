...
def initialize_tvb_model(loader, ezregions, pzregions, period, **kwargs):
    ...
    maintvbexp = MainTVBSim(conn, condspeed=3.0)
    ...
    maintvbexp.importsurfdata(surf=loader.surface)
    ...
    epileptor_params = {
        'r': 0.00037/1.25,   # Temporal scaling in the third state variable
