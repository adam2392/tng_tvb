...
if __name__ == '__main__':
    ...
    patient = 'id001_bt'
    outputdatadir = os.path.expanduser('~/Downloads/tvbsim/output')
    metadatadir = os.path.expanduser('~/Downloads/tngpipeline')
    movedist = -1
    freqoutputdatadir = os.path.expanduser('~/Downloads/tvbsim/freqoutput')
    shuffleweights = 0
    ...
    for i in range(numsims):
        ...
        outputfilename = os.path.join(freqoutputdir, 
                '{}_{}_{}model.npz'.format(patient, mode, (i)+1))
        outputmetafilename = os.path.join(freqoutputdir,
            '{}_{}_{}meta.json'.format(patient, mode, (i)+1))
